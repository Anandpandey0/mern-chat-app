...
const accessAllChats = asyncHandler(async (req, res) => {
  const { userId } = req.body;
  if (!userId) {
    console.log("userId is not sent via req");
...
module.exports = { accessAllChats ,fetchAllChats,createGroups,renameGroup,removeGroup,addnewgroupmember};
